...
class PlaneModel(nn.Module):
    ...
    def forward(self, x):
        ...
        v = rearrange(v, 'B (nh hs) -> B nh hs', nh=self.n_head)
        # here our information communicated between heads
        # if our qk shape is B nh T hs, then
        # our information communicated between T 
